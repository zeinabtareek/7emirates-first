...
class ProductItemCardHorizontal extends StatefulWidget {
  int i;
  List getProducts = [];
  GestureTapCallback btnClick;
  ProductItemCardHorizontal(
      {Key? key,
      required this.i,
  ...
  @override
  _ProductItemCardHorizontalState createState() {
    return _ProductItemCardHorizontalState();
  }
}

class _ProductItemCardHorizontalState extends State<ProductItemCardHorizontal>
    with RelativeScale {
  @override
  void initState() {
    super.initState();
          ...
          child: Column(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                      ...
                      if (widget.getProducts[widget.i]["p_lable"].toString() !=
                              "null" &&
                      ...
                      if (widget.getProducts[widget.i]["p_status"] != 'A')
                        Positioned(
                            ...
                            child: Container(
                              decoration:
                                  decoration_round(Colors.red[500], 0, 0, 0, 0),
                              alignment: Alignment.center,
                              width: MediaQuery.of(context).size.width,
                              padding: EdgeInsets.fromLTRB(
                                  sy(2), sy(3), sy(2), sy(3)),
                      ...
                      Positioned(
                          ...
                          child: GestureDetector(
                            ...
                            child: Container(
                              decoration: decoration_round(
                                  Colors.white, sy(10), sy(10), sy(10), sy(10)),
                              padding: EdgeInsets.fromLTRB(
                                  sy(3), sy(3), sy(3), sy(3)),
              ...
              Row(
                ...
                children: [
                  Text(
                    PriceUtils.convert(widget.getProducts[widget.i]["p_sell"]),
