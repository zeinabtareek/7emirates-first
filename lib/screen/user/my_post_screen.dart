...
class _MyPostScreenState extends State<MyPostScreen> with RelativeScale {
  ...
  _myProducts() async {
    showProgress = true;
    final response = await http.post(Uri.parse(Urls.UserPost), headers: {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    if (productList.length == 0 && showProgress != true)
                      emptyCart(),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  Lang(" Let Sell Anything ", "دعنا نبيع أي شئ"),
                  style: ts_Bold(sy(xl), fc_1),
                ),
                SizedBox(
                  height: sy(10),
  ...
  getProductItem(int i) {
    return Container(
      ...
      child: Container(
        ...
        decoration: decoration_round(fc_bg, sy(3), sy(3), sy(3), sy(3)),
        child: Container(
                  ...
                  children: [
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            decoration: decoration_round(Colors.grey.shade100,
                                sy(2), sy(2), sy(2), sy(2)),
                            child: Text(
                    ...
                    Row(
                      children: [
                        ...
                        Switch(
                          value: statusCheck(
                              productList[i]['p_status'].toString()),
                          onChanged: (val) {
    ...
    return Container(
      child: Column(
        ...
        children: [
          ...
          Text(
            Lang(" No ads found ", "لا توجد إعلانات  "),
                ...
                ListTile(
                    ...
                    onTap: () => {
                          ...
                          Navigator.push(
                              context,
                              OpenScreen(
                                  widget: StoreProductViewScreen(
                                      pid: pid, pimage: '', pname: 'Loading'))),
                        }),
                ListTile(
                    leading: Icon(Icons.edit),
                    title: Text(Lang('Edit Product', 'تحرير المنتج')),
                    onTap: () => {
                          Navigator.pop(context),
                          // Navigator.pushReplacement(context, OpenScreen(widget: AddProduct(pid: pid ))),
                        }),
                SizedBox(
                  height: sy(10),
                )
