...
import 'package:sevenemirates/screen/user/user_booking_view_screen.dart';
...
class _UserBookingScreenState extends State<UserBookingScreen>
  ...
  _myProducts() async {
    showProgress = true;
    final response = await http.post(Uri.parse(Urls.UserBooking), headers: {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    if (ordersList.length == 0 && showProgress != true)
                      emptyCart(),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  Lang(" Lets view your order ", "دعنا نرى طلباتك"),
                  style: ts_Bold(sy(xl), fc_1),
                ),
                SizedBox(
                  height: sy(10),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            OpenScreen(
                                widget: UserBookingViewScreen(
                              oid: ordersList[i]['o_id'],
                            )));
                      },
                                ...
                                Expanded(
                                  ...
                                  children: [
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            decoration: decoration_round(
                                                ...
                                                sy(2)),
                                            child: Text(
                                              ordersList[i]["c_name$cur_Lang"]
                                                  .toString()
                                                  .toUpperCase(),
                                              style:
                                                  ts_Regular(sy(s - 1), fc_4),
                                              maxLines: 1,
                                            ),
                                          ),
                                          Container(
                                          ...
                                          Container(
                                            ...
                                            decoration: decoration_round(
                                                ...
                                                sy(2)),
                                            child: Text(
                                              ordersList[i]["sc_title$cur_Lang"]
                                                  .toString()
                                                  .toUpperCase(),
                                              style:
                                                  ts_Regular(sy(s - 1), fc_4),
                                    ...
                                    Row(
                                      children: [
                                        Text(
                                          PriceUtils.convert(ordersList[i]
                                                  ['total_price']
                                              .toString()),
                                          style: ts_Bold(sy(n), fc_3),
                                          maxLines: 2,
  ...
  cardOrderStatus(String status) {
    ...
    return Container(
      ...
      child: Text(
        lable,
        style: ts_Regular(sy(s - 1), Darkclr),
      ),
    );
  }
