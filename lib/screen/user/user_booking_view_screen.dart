...
class UserBookingViewScreen extends StatefulWidget {
  String oid = '';
  UserBookingViewScreen({Key? key, this.oid = ''}) : super(key: key);
  @override
  _UserBookingViewScreenState createState() => _UserBookingViewScreenState();
}

class _UserBookingViewScreenState extends State<UserBookingViewScreen>
    with RelativeScale {
  ...
  _myProducts() async {
    showProgress = true;
    final response = await http.post(Uri.parse(Urls.UserBookingView), headers: {
            ...
            child: Column(
              ...
              children: [
                Container(
                  padding: EdgeInsets.fromLTRB(sy(5), sy(5), sy(5), sy(5)),
                  child: Text(
                    Lang(" Vendor Summary ", "ملخص البائع  "),
                    style: ts_Bold(sy(n), fc_2),
                  ),
                ),
                SizedBox(
        ...
        child: SingleChildScrollView(
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                child:
                    tabbutton(FontAwesomeIcons.whatsapp, Lang('whatsapp', 'ال WhatsApp')),
                onTap: () {
