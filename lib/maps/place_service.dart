...
class PlaceApiProvider {
  ...
  static final String androidKey = Const.GOOGLEAPI_ANDROID;
  static final String iosKey = Const.GOOGLEAPI_IOS;
  ...
  Future<List<Suggestion>> fetchSuggestions(String input, String lang) async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception(
        Lang('Failed to fetch suggestion', 'فشل في جلب الإقتراح'),
      );
    }
  }
